...
<div class="bg-gray-100">
  <div class="grid min-h-screen place-items-center">
    <div class="w-11/12 p-12 bg-white sm:w-10/12 overflow-hidden shadow-md">
      <h1 class="text-xl font-semibold">Hello there 👋, <span class="font-normal">check out this awesome table!</span></h1>
        ...
        <table class="mt-6 table-auto">
          <thead>
            <tr>
              ...
              <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Verification</th>
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                ...
                <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                  ...
                  <span class="relative text-xs">verified</span>
